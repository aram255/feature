                    ...
                    <form class="auth" method="POST" action="{{ route('register.custom',[app()->getLocale()]) }}" enctype='multipart/form-data'>
                        ...
                        <div class="form-info">
                            ...
                            <div class="user-info box">
                                <p>ID or Passport</p>
                                <input type="file" id="idPass" class="file_name_trigger" name="id_or_passport">
                                <label for="idPass" style="color: black">
                            ...
                            <div class="user-info box">
                                ...
                                <input type="file" id="certificat" name="certifications_licensing" class="file_name_trigger">
