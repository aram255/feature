        ...
        <div class="container">
            <div class="lg-sg">
                ...
                <div class="change-pass lg-sg__form">
                    ...
                    <form method="POST" action="{{ route('reset-password-practitioners',[app()->getLocale()]) }}">

                      @csrf
                           <input type="hidden" name="token" value="{{ Request::segment(3) }}">

                        <p class="lg-sg-p">E-mail</p>
                        <input type="email" class="fadeIn email" name="email" value="{{old('email') }}" autocomplete="email" autofocus>
