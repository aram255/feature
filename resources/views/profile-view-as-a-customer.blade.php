                    ...
                    <div class="profile-customer__blok1-info">
                        <div class="person__info-cont1">
                            ...
                            <div class="person__info-name">
                                <span class="person-customer-name">Name Surname</span>
                            ...
                            <div class="person-customer__payments">
                                <div class="person-customer__payments-phone">
                                    ...
                                    <p class="person-customer-tel">+656 56 56 46</p>
                                </div>
                                <div class="person-customer__payments-email">
                                    <p class="person-customer-email">Email</p>
                                    <p class="person-customer-email-addres">example@gmail.com</p>
                                </div>
                        ...
                        <div class="profile-customer-reviews-cont">
                            <div class="profile-customer-reviews-cont__info">
                                <div class="profile-customer-reviews-cont__info-cont1">
                                    <img class="profile-customer-reviews-cont__info-img" src="{{ asset('web_sayt/img/person-foto.png') }}" alt="">
                                </div>
